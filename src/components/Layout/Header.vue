    ...
    >
      <template slot="brand">
        <b-navbar-item tag="div">
          <img :src="rajorImg" alt="logo" width="90px" height="50px">
        </b-navbar-item>
      ...
      <template slot="start">
        <b-navbar-item
          ...
          :to="{ path: '/' }"
        >
          <img :src="zyImg" height="25px" width="25px" style="margin-right:10px;"/> 主页
        </b-navbar-item>
      </template>
      ...
      <template slot="end">
        ...
        >
          <div class="buttons">
            ...
            <!-- <router-link to='quiz.html'><button>页面</button></router-link> -->
            <b-button
              class="is-light"
              tag="router-link"
              :to="{ path: '/login' }"
